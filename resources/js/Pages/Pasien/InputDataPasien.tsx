...
export default function InputDataPasien({ auth, mustVerifyEmail, status }: PageProps<{ mustVerifyEmail: boolean, status?: string }>, { className = '' }) {
          ...
          <div className="mx-auto bg-cyan-600 px-4 py-4 ">
                        <section className={className}>
                            ...
                            <form onSubmit={handleSubmit} className="grid grid-cols-2">
                                <div className="m-3">
                                    <InputLabel className='text-black dark:text-white' htmlFor="no_rm" value="No. RM" />
                                    <TextInput
                                        id="no_rm"
                                        ref={noRMInput}
                                        value={data.no_rm}
                                ...
                                <div className="m-3">
                                    <InputLabel className='text-black dark:text-white' htmlFor="status_pasien" value="Status Pasien" />
                                    <TextInput
                                        id="status_pasien"
                                ...
                                <div className="m-3">
                                    <InputLabel className='text-black dark:text-white' htmlFor="nama_pasien" value="Nama Pasien" />
                                    <TextInput
                                        id="nama_pasien"
                                        ref={namaPasienInput}
                                ...
                                <div className="m-3">
                                    <InputLabel className='text-black dark:text-white' htmlFor="no_bpjs" value="No. BPJS" />
                                    <TextInput
                                        id="no_bpjs"
                                        ref={noBpjsInput}
                                        value={data.no_bpjs}
                                ...
                                <div className="m-3">
                                    <InputLabel className='text-black dark:text-white' htmlFor="tanggal_lahir" value="Tanggal Lahir" />
                                    <TextInput
                                        id="tanggal_lahir"
                                ...
                                <div className="m-3">
                                    <InputLabel className='text-black dark:text-white' htmlFor="alamat" value="Alamat" />
                                    <TextInput
                                        id="alamat"
                                        ref={alamatInput}
                                        value={data.alamat}
                                ...
                                <div className="m-3">
                                    <InputLabel className='text-black dark:text-white' htmlFor="jenis_kelamin" value="Jenis Kelamin" />
                                    <TextInputSelect
                                        id="jenis_kelamin"
                                ...
                                <div className="m-3">
                                    <InputLabel className='text-black dark:text-white' htmlFor="no_kontak" value="No. Kontak" />
                                    <TextInput
                                        id="no_kontak"
                                        ref={noKontakInput}
