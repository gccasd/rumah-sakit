...
export default function DaftarPasien({ auth, pemeriksaan, page }: PageProps) {
  ...
  const handleSearchQuery = async (e: ChangeEvent<HTMLInputElement>) => {
    e.preventDefault();
    console.log(isPageNumber(url, "/hasil-pemeriksaan-validasi"));
    if (isPageNumber(url, "/hasil-pemeriksaan-validasi")) {
      ...
      <div className="py-12">
        <div className="mx-auto sm:px-6 lg:px-8">
          ...
          <div className="bg-cyan-800 px-4 py-4">
            <h3 className="text-2xl font-medium text-white">VALIDASI HASIL</h3>
          </div>
