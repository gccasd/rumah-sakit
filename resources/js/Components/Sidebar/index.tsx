...
import { isPageNumber } from "@/types/helper";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-cyan-700 duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        sidebarOpen ? "translate-x-0" : "-translate-x-full"
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-10 py-5.5 lg:py-10.5">
        <Link className="text-white flex" href="/">
          <div className="text-2xl">
            <FontAwesomeIcon icon={faHospitalAlt} size="2xl" />
          </div>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            <h3 className="mb-4 ml-4 text-sm font-semibold text-neutral-300">
              MENU
            </h3>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-cyan-700 dark:hover:bg-meta-4 ${
                    pathname.includes("profile") && "bg-cyan-800 dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              {/* <!-- Menu Item Management Pasien --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/pasien" || url.includes("pasien")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              {/* <!-- Menu Management Pasien --> */}

              {/* <!-- Menu Item Pemeriksaan --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/list-pemeriksaan" ||
                  pathname.includes("list-pemeriksaan") ||
                  pathname === "/order-pemeriksaan" ||
                  url.includes("order-pemeriksaan")
                }
              >
                {(handleClick, open) => {
                  return (
                    <div>
                      <Link
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-cyan-700 dark:hover:bg-meta-4 ${
                          (pathname === "/forms" ||
                            pathname.includes("order-pemeriksaan") ||
                            pathname.includes("list-pemeriksaan")) &&
                          "bg-cyan-800 dark:bg-meta-4"
                        }`}
                        onClick={(e) => {
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/list-pemeriksaan"
                              className={
                                url === "/list-pemeriksaan"
                                  ? "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark duration-300 ease-in-out hover:text-white " +
                                    (url === "/list-pemeriksaan" &&
                                      "!text-white font-semibold")
                                  : "text-neutral-300"
                          ...
                          <li>
                            <Link
                              href="/order-pemeriksaan"
                              className={
                                url === "/order-pemeriksaan" ||
                                pathname.includes("order-pemeriksaan")
                                  ? "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark duration-300 ease-in-out hover:text-white " +
                                    (pathname.includes("order-pemeriksaan") &&
                                      "!text-white font-semibold")
              ...
              <SidebarLinkGroup
                activeCondition={
                  url.includes("hasil-pemeriksaan-validasi") ||
                  url.includes("hasil-pemeriksaan")
                }
              >
                {(handleClick, open) => {
                  return (
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={
                                url.includes("/hasil-pemeriksaan?search") ||
                                url === "/hasil-pemeriksaan"
                                  ? "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark duration-300 ease-in-out hover:text-white " +
                                    ((url.includes(
                                      "hasil-pemeriksaan?search="
                                    ) ||
                                      url === "/hasil-pemeriksaan") &&
                                      "!text-white font-semibold")
                                  : "text-neutral-300"
                          ...
                          <li>
                            <Link
                              href="/hasil-pemeriksaan-validasi"
                              className={
                                url.includes("/hasil-pemeriksaan-validasi")
                                  ? "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark duration-300 ease-in-out hover:text-white " +
                                    (url.includes(
                                      "/hasil-pemeriksaan-validasi"
                                    ) && "!text-white font-semibold")
                                  : "text-neutral-300"
                              }
                            >
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname.includes("daftar-pembayaran") ||
                  pathname.includes("data-pembayaran")
                }
              >
                {(handleClick, open) => {
                  return (
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={
                                url.includes("/daftar-pembayaran")
                                  ? "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark duration-300 ease-in-out hover:text-white " +
                                    (url.includes("/daftar-pembayaran") &&
                                      "!text-white font-semibold")
                                  : "text-neutral-300"
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname.includes("laporan-rawat-jalan") ||
                  pathname.includes("laporan-keuangan")
                }
              >
                {(handleClick, open) => {
                  return (
                    <div>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-cyan-700 dark:hover:bg-meta-4 ${
                          (url.includes("laporan-rawat-jalan") ||
                            url.includes("laporan-keuangan")) &&
                          "bg-cyan-800 dark:bg-meta-4"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
              ...
              <li>
                <button
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-cyan-700 dark:hover:bg-meta-4 ${
                    pathname === "/" ||
                    (pathname.includes("@") && "bg-cyan-800 dark:bg-meta-4")
                  }`}
                >
